...
The chair should not only be for fun but it should also be useful in the activities of flying clubs. Therefore, the chair has been equipped with a dual command to help noobs into the gospel of gliding. That is also what distinguishes this build from all the other simulator chairs on the web. At least the ones I have found.
